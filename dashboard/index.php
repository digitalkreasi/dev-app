...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TC6MF6D" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <div id="app">
        ...
        <header class="header-global">
            <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                <div class="container">
                    <a class="navbar-brand" href="https://solusimedia.com/dashboard/"><img src="<?php echo $config['web']['url'] ?>assets/media/logos/logooke.png" alt="logo" height="50" width="170"></a>
                    ...
                    <div class="row align-center" style="margin-top:80px">
                        <div class="col-lg-6 col-md-7">
                            ...
                            <div class="mt-4">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.solusimedia.app" target="blank" class="btn btn-outline-danger mt-2 text-white"><i class="mdi mdi-register"></i>Playstore</a>
                                <div id="response"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-7">
                            <img class="img-fluid" src="https://faspay.co.id/wp-content/uploads/2020/11/Group-1081.png" alt="Hero">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="cara" id="cara" style="background-image: linear-gradient( 180deg, #0cbae2 0%, #f9faff 100%);">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img src="assets/img/howto.png" alt="project" class="img-fluid">
                    </div>
                    <div class="col-lg-6">
                        <div class="box">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="items">
                            ...
                            <h3><span class="counter"><?php echo number_format($data_deposit['total'], 16, ',', '.'); ?></span></h3>
                            <div class="line mx-auto"></div>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-5">
                        <div class="right">
                            ...
                            <h2>OKEPEDIA <br><span>FOUNDER & CEO of OKEPEDIA</span></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="block-icon">
                    <center>
                        <h3 style="font-size:20px;font-weight:bold;">
                            <font color=''>MENDUKUNG PEMBAYARAN DARI METODE BERIKUT</font>
                        </h3>
                    </center>
                </div>
                            ...
                            <div class="content">
                                ...
                                <div class="info d-flex align-items-start">
                                    ...
                                    <h4 class="d-inline-block">NOMOR WHATSAPP :
                                        <br>
                                        <a href="https://api.whatsapp.com/send?phone=<?php echo $data_kontak['no_wa']; ?>" target="_blank"><span><?php echo $data_kontak['no_wa']; ?></span></a>
                                    </h4>
                                </div>
                                <!-- INFO-2 -->
                                <div class="info d-flex align-items-start">
                        ...
                        <div class="kt-footer__logo">
                            <center>
                                <div class="kt-footer__copyright">
                                    Copyright &copy; 2021 <a href="<?php echo $config['web']['url'] ?>" class="kt-link"><?php echo $data['short_title']; ?></a> Di Buat Dengan <i class="fa fa-heart text-danger"></i> Oleh <a href="https://abesar.my.id" target="_blank" class="kt-link">Okepedia</a>.
                                </div>
...
<script type='text/javascript'>
    ...
    function redirectCU(e) {
        if (e.ctrlKey && e.which == 85) {
            window.location.replace("https://solusimedia.com/");
            return false;
        }
    }
